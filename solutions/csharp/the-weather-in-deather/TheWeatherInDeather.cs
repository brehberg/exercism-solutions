...
public class WeatherStation
{
    ...
    public Outlook ShortTermOutlook =>
        RunSelfTest() == State.Bad ? throw new ArgumentException()
        : reading switch
        {
            { Temperature: var t, Pressure: var p } when p < 10m && t < 30m => Outlook.Cool,
            { Temperature: var t } when t > 50m => Outlook.Good,
            _ => Outlook.Warm,
        };
